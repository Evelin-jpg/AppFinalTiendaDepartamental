...
public class SolicitarCreditoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMenu.setOnClickListener(v -> {
            Intent intent = new Intent(SolicitarCreditoActivity.this, MenuActivity.class);  // Cambia MenuActivity a la actividad de tu menú
        ...
        btnAceptar.setOnClickListener(v -> {
            ...
            if (edtComprobanteDomicilio.getText().toString().isEmpty() || edtINE.getText().toString().isEmpty()) {
                ...
                new AlertDialog.Builder(SolicitarCreditoActivity.this)
                        .setTitle("Error")
                ...
                new AlertDialog.Builder(SolicitarCreditoActivity.this)
                        ...
                        .setMessage("La solicitud en aumento de credito a sido enviado correctamente. Favor de esperar a la confirmación.")
