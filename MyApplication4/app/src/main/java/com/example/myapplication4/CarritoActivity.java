...
public class CarritoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnProducto4 = findViewById(R.id.btnProducto4);
        Button btnProducto5 = findViewById(R.id.btnProducto5);
        Button btnProducto6 = findViewById(R.id.btnProducto6);
        ...
        btnProducto1.setOnClickListener(v -> agregarProducto("Conjunto Femenino", 100));
        btnProducto2.setOnClickListener(v -> agregarProducto("Conjunto Masculino", 150));
        btnProducto3.setOnClickListener(v -> agregarProducto("Accesorio", 200));
        btnProducto4.setOnClickListener(v -> agregarProducto("Collar de mariposa", 75));
        btnProducto5.setOnClickListener(v -> agregarProducto("Reloj Masculino", 250));
        btnProducto6.setOnClickListener(v -> agregarProducto("Celular Samsung", 2192));
        ...
        btnRegresarConsulta.setOnClickListener(v -> {
            Intent intent = new Intent(CarritoActivity.this, ConsultaActivity.class);
